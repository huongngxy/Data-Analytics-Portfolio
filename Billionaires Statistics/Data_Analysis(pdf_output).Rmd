...
billionaires_missing_gdp <- Billionaires_Statistics_Dataset %>% filter(is.na(Billionaires_Statistics_Dataset$gdp_country)) # select data with missing values in column gdp_country 
billionaires_missing_gdp

billionaires_missing_gdp_grouped <- billionaires_missing_gdp %>% group_by(country) #group data with missing values in gdp_country by country 
billionaires_missing_gdp_grouped



billionaires_missing_gdp_summary <- billionaires_missing_gdp_grouped %>% summarize(billionaires_count = n()) # count how many billionaires do the listed countries with missing values have
...
# 2. Distribution {.tabset}
## 2.1 By Industry {.tabset}
```{r Figure 1, fig.align="center", fig.cap="Distribution of world's billionaires by industry", out.height='100%', out.width='100%'}
...
\newpage
## 2.2 By Gender
```{r Figure 2 , fig.align="center", fig.cap="Distribution of world's billionaires by gender.", out.height='100%', out.width='100%'}
...
## 2.3 By Country
```{r figure 3,  fig.align="center", fig.cap="Distribution of world's billionaires by country", out.height='100%', out.width='100%'}
...
## 2.4 By Status 
```{r figure 4, fig.align="center", fig.cap="Distribution of word's billionaires by status", out.height='100%', out.width='100%'}
...
## 2.5 By Age 
```{r Figure 5, echo = FALSE, fig.retina=2, out.width="400px", fig.cap="Age distribution of world's billionaires"}

knitr::include_graphics("C:/Users/lhuon/OneDrive - HWR Berlin/WS 23,24/Datenanalyse/Plot - Age distribution.png")
```
...
```{r figure 6, fig.align="center", fig.cap="Top 10 richest people in the world (2023)", out.height='100%', out.width='100%'}
...
plot_top10 <- ggplot(top10, aes(x = reorder(personName, finalWorth_bln), 
  ...
  geom_bar(stat = 'identity') +
  geom_text(aes(label = finalWorth_bln),hjust = -0.5, size = 1.6)  + 
...
# 3 Crosstabulations {.tabset}

## 3.1 Industries and Age groups 

```{r figure 7, fig.align="center", fig.cap="Percentage of different industries in different age groups", out.height='100%', out.width='100%'}
...
```{r figure 8, echo=FALSE, fig.align="center", fig.cap="Chi-Square Tests - computed in IBM SPSS", out.height= '60%', out.width='60%'}
...
```{r figure 9, fig.align="center", fig.cap="Average net worth by industry", out.height="100%", out.width="100%"}
